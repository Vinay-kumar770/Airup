 ...
 function EntrepreneurRegister() {
   ...
   const navigate = useNavigate();
    ...
    const handleSignUp = async (event) => {
        ...
        try {
            const response = await axiosInstance.post('/backend/entrepreneur/register', {
    ...
    const handleSignIn = async (event) => {
        event.preventDefault(); // Prevent the form from refreshing the page
        try {
            const response = await axiosInstance.post('/backend/entrepreneur/login', {
                email: formData.email,
                password: formData.password,
            });
          ...
          <Components.Container>
              <Components.SignUpContainer signinin={signIn}>
                  <Components.Form onSubmit={handleSignUp}>
                      ...
                      <Components.Input type='text' placeholder='Name' name='username' onChange={handleInputChange}/>
